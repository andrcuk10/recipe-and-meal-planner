      ...
      >
        ...
        <CardContent class-name="space-y-4">
          ...
          <RouterLink :to="{ name: 'Meal Plan' }" class="flex-1">
            <ButtonItem
              class-name="w-full bg-600 bg-[var(--primary-blue)] hover:bg-blue-700 text-white"
      ...
      >
        ...
        <CardContent class-name="space-y-4">
          ...
          <RouterLink :to="{ name: 'Shopping List' }" class="flex-1">
            <ButtonItem
              class-name="w-full bg-600 bg-[var(--primary-orange)] hover:bg-orange-700 text-white"
